...
A complexidade crescente presente nos computadores faz com que diversas
funcionalidades se tornem obsoletas. Para o domínio de sistemas
operacionais, a evolução também se mostra verdadeira.
No contexto de utilização de disco, o sistema operacional encapsula a
comunicação com periféricos em chamadas de rotina simples e genéricas que
...
arquivos.
Assim sendo, neste trabalho os sistemas de arquivos Ext4, XFS e ReiserFS foram
analisados em comparação uns aos outros. Ao fim da realização dos experimentos
